...
from umust.midi_utils.note_event_dataclasses import Event, EventRange, Note  #, Codec
from umust.midi_utils.event_codec import FastCodec as Codec
from umust.midi_utils.note_event_dataclasses import NoteEvent
from umust.midi_utils.note2event import note_event2event
from umust.midi_utils.event2note import event2note_event, note_event2note
...
class NoteEventTokenizer(EventTokenizerBase):
    ...
    def __init__(
        ...
        self.eos_idx = self.codec.special_tokens.index('EOS')
        self.sos_idx = self.eos_idx
        self.pad_idx = self.codec.special_tokens.index('PAD')
