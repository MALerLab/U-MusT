...
from umust.midi_utils.note2event import note2note_event, mix_notes
import mirdata
from umust.yourmt3plus.utils.mirdata_dev.datasets import slakh16k
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Preprocess the SLakh dataset')
    parser.add_argument('--data_home', type=str, default='dataset/', help='directory containing the slakh2100_flac_redux download')
    args = parser.parse_args()
    preprocess_slakh16k(data_home=args.data_home, delete_source_files=False)