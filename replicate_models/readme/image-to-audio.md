...
A list of files (order may vary): `u-must.wav`, `meta.json` (`duration_sec`, `n_systems`, `notes`),
`systems.png` (all played system crops stacked in playback order) and `system_NN.png` (each crop, labelled).
